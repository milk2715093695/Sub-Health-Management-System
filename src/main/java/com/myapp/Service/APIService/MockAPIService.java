        ...
        new Thread(() -> {
            try {
                final String text = """
                        ...
                        In the world of coding, the possibilities are endless. So, whether you're interested in building the next viral app, revolutionizing an industry, or simply automating tedious tasks, learning to code can provide you with the toolset needed to turn your ideas into reality.\s""";
