...
[功能演示视频](https://pan.baidu.com/s/19IHNvadttzth2YwWC_GNhg?pwd=q46h)
...
![登录界面](./pictures/登录页面.png)

> + 采用“用户名+密码”的登录形式，支持用户快速登录查看自己的健康数据
> + 中英文切换，语言设置一次即始终记住，并且随时可以更改回去


### 健康测试

![体质测试](./pictures/体质评测.png)
![心理测试](./pictures/心理评测.png)
![风险测试](./pictures/风险评测.png)
